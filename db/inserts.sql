...
INSERT INTO `Hotel`.`Personas` (`nombre`, `apellido`, `email`, `nroDocumento`, `tipoDocumento`, `genero`, `fechaNacimiento`, `cuit`, `telefono`, `fechaCreacion`, `idDomicilio`) VALUES
('Juan', 'Perez', 'jperez@gmail.com', 30444888, 'DNI', 'Masculino', '1990-10-10', '20-30444888-3', 3416777888, '2020-01-01 13:00:00', 1),
('Pedro', 'Rodriguez', 'prodriguez@gmail.com', 20555888, 'DNI', 'Masculino', '1980-04-15', '20-20555888-1', 3416123456, '2020-01-01 13:00:00', 2),
('Esteban', 'Quito', 'equito@gmail.com', 35777888, 'DNI', 'Masculino', '1992-01-16', '20-35777888-7', 3416999456, '2020-01-01 13:00:00', 3),
('Federico', 'Fernandez', 'ffernandez@gmail.com', 25444888, 'DNI', 'Masculino', '1985-02-14', '20-25444888-4', 3416123888, '2020-01-01 13:00:00', 4);
...
INSERT INTO `Hotel`.`Tarjetas` (`numeroTarjeta`, `nombreTarjeta`, `fechaVencimiento`, `monto`, `fechaCreacion`, `idCliente`) VALUES
(4546102010204546, 'Visa', '2023-01-01 13:00:00', 123000, '2020-01-01 13:00:00', 1),
(4558999988887777, 'Mastercard', '2023-03-01 13:00:00', 64000, '2020-01-01 13:00:00', 1),
(5896102010204546, 'Mastercard', '2024-10-01 13:00:00', 157000, '2020-01-01 13:00:00', 2),
(4546102010204546, 'Visa', '2023-11-01 13:00:00', 85000, '2020-01-01 13:00:00', 2);
...
INSERT INTO `Hotel`.`Reservas` (`fechaReserva`, `cantDias`, `fechaEntrada`, `fechaCreacion`, `idHabitacion`, `idEstadoReserva`, `idCliente`) VALUES
('2020-02-01 13:00:00', 7, '2021-02-02 13:00:00', '2020-01-01 13:00:00', 12, 1, 1),
('2020-02-10 13:00:00', 1, '2021-03-02 13:00:00', '2020-01-01 13:00:00', 4, 1, 1),
('2020-04-01 13:00:00', 14, '2021-04-02 13:00:00', '2020-01-01 13:00:00', 5, 1, 2),
('2020-05-01 13:00:00', 7, '2021-06-02 13:00:00', '2020-01-01 13:00:00', 16, 1, 2);

INSERT INTO `Hotel`.`Reservas` (`fechaReserva`, `fechaCancelacion`, `cantDias`, `fechaEntrada`, `fechaCreacion`, `idHabitacion`, `idEstadoReserva`, `idCliente`) VALUES
('2020-08-01 13:00:00', '2020-09-01 13:00:00', 7, '2021-04-02 13:00:00', '2020-01-01 13:00:00', 7, 2, 1),
('2020-08-01 13:00:00', '2020-09-01 13:00:00', 7, '2021-04-02 13:00:00', '2020-01-01 13:00:00', 8, 2, 2);

INSERT INTO `Hotel`.`Reservas` (`fechaReserva`, `cantDias`, `fechaEntrada`, `fechaCreacion`, `idSalon`, `idEstadoReserva`, `idCliente`) VALUES
('2020-06-01 13:00:00', 1, '2021-10-10 13:00:00', '2020-01-01 13:00:00', 2, 1, 1),
('2020-07-10 13:00:00', 1, '2021-11-11 13:00:00', '2020-01-01 13:00:00', 3, 1, 1),
('2020-06-01 13:00:00', 1, '2021-10-10 13:00:00', '2020-01-01 13:00:00', 1, 1, 2),
